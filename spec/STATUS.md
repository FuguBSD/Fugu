...
| [ARC-COREPERL](architecture.md#arc-coreperl)     | done    | —       | [coreperl.t](../t/fugu/coreperl.t), [conventions.t](../t/scripts/conventions.t)                                                               |
...
| [LIB-OPENPGP](library.md#lib-openpgp)            | done    | —       | [OpenPGP.pm](../lib/Fugu/OpenPGP.pm), [openpgp.t](../t/fugu/openpgp.t). It inherits Fugu::Signer, and each half is a path.                    |
...
| [LIB-SIGNER](library.md#lib-signer)              | done    | —       | [Signer.pm](../lib/Fugu/Signer.pm), [signer.t](../t/fugu/signer.t). Each of the three signers inherits the class.                             |
| [LIB-SIGNIFY](library.md#lib-signify)            | done    | —       | [Signify.pm](../lib/Fugu/Signify.pm), [signify.t](../t/fugu/signify.t). It inherits Fugu::Signer, and the perl engine is the default.         |
...
| [LIB-X509](library.md#lib-x509)                  | done    | —       | [X509.pm](../lib/Fugu/X509.pm), [x509.t](../t/fugu/x509.t). It inherits Fugu::Signer, and generate makes a certificate.                       |
...
| [REL-PORT](release.md#rel-port)                  | partial | —       | [p5-Fugu](../ports/devel/p5-Fugu). The port builds and its tests pass on OpenBSD/arm64 (2026-09-26). The amd64 proof of REL-PORT-5 is absent. |
